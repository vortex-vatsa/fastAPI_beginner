...
class Book:
    ...
    def __init__(self, id: int, title: str, author: str, category: str, description: str, rating: float):
        self.id = id
        self.title = title
        self.author = author
...
BOOKS = [
    ...
    Book(2, "To Kill a Mockingbird", "Harper Lee", "Fiction", "A novel about the serious issues of rape and racial inequality, narrated by the young Scout Finch.", 4.8),
    Book(3, "1984", "George Orwell", "Dystopian", "A novel that presents a terrifying vision of a totalitarian future society.", 4.7),
    Book(4, "Pride and Prejudice", "Jane Austen", "Classic", "A romantic novel that charts the emotional development of the protagonist, Elizabeth Bennet.", 4.6),
    Book(5, "The Catcher in the Rye", "J.D. Salinger", "Coming-of-Age", "A novel about the experiences of a teenager, Holden Caulfield, in New York City after being expelled from prep school.", 4.3)
]
